...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onNewToken(token: String) {
        ...
        // Sau này Hào viết hàm gọi API gửi token này lên Server .NET để lưu vào Database nhé
    }
    ...
    override fun onMessageReceived(message: RemoteMessage) {
        ...
        val title = message.notification?.title ?: "Thông báo từ SportMatch"
    ...
    private fun showNotification(title: String, body: String) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channel = NotificationChannel(channelId, "Thông báo SportMatch", NotificationManager.IMPORTANCE_HIGH)
        ...
        val notification = NotificationCompat.Builder(this, channelId)
            ...
            .setContentText(body)
            .setSmallIcon(android.R.drawable.ic_dialog_info) // Hào có thể đổi thành icon riêng của app
            .setAutoCancel(true)
            .build()
